...
export const translations = {
  fr: {
    ...
    roles: {
      ...
      collaborateur: 'Collaborateur TOA',
  ...
  mg: {
    ...
    nav: {
      ...
      interventions: 'Fanaraha-maso ny drafitra',
      users: 'Mpampiasa',
      statistics: 'Statistika',
      access: 'Fitantanana ny fidirana',
    ...
    roles: {
      ...
      collaborateur: 'Mpiara-miasa TOA',
